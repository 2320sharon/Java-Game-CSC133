...
public class Game extends Form implements Runnable{
	...
	public Game(){
		...
		//set MapView's winRight and winTop to temporary values
		mv.setWinRight(0);
		mv.setWinTop(0);
		
		show();	
		System.out.println("mv.getHeight()"+ mv.getHeight() + "mv.getWidth() "+mv.getWidth());
		gw.setHeight(mv.getHeight());
		gw.setWidth(mv.getWidth());
		
		//set MapView's winRight and winTop to mapView's height and Width 
//		mv.setWinRight(mv.getWidth());
//		mv.setWinTop(mv.getHeight());
		mv.setWinRight(mv.getWidth()/2);
		mv.setWinTop(mv.getHeight()/2);	
		System.out.println("mv.getHeight()/2: "+ mv.getHeight()/2 + "mv.getWidth()/2: "+mv.getWidth()/2);
